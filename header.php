...
<head>
    ...
    <link rel="Shortcut Icon" href="<?php $this->options->themeUrl('icon.png'); ?>" />
    <link rel="Bootmark" href="<?php $this->options->themeUrl('icon.png'); ?>" />
    <?php $this->header('generator=&template=&pingback=&xmlrpc=&wlw='); ?>
	<link rel="stylesheet" href="https://dn-biezhi.qbox.me/font-awesome.min.css">
	<link rel="stylesheet" href="<?php $this->options->themeUrl('fancybox/jquery.fancybox.css'); ?>" media="screen" type="text/css">
...
<div class="wrapper">
	<header id="header">
	  <div class="title">
	    ...
	    <p><a href="<?php $this->options ->siteUrl(); ?>"><?php $this->options->description() ?></a></p>
	  </div>
	  <nav class="nav">
	    <ul>	      
